...
static void CG_OffsetThirdPersonView( void ) {
	...
	if ( cg.predictedPlayerState.stats[STAT_HEALTH] <= 0 && cgs.gametype != GT_FREEZE ) {
...
//unlagged - lag simulation #1
	...
	if (cg_aimType.integer > 3 || cg_aimType.integer < 0 )
	{
		trap_Cvar_Set("cg_aimType", "2");
		cg_aimType.integer = 2;
	}

	//memset(&cg.rawPacket, 0, sizeof(aimtype4packet_t));

	// any looped sounds will be respecified as entities
	// are added to the render list
	//CG_Printf("Before ClearLoopSounds: %i -- %i\n", cgs.clientinfo[cg.clientNum].powerups, cgs.clientinfo[cg.clientNum].score);
	trap_S_ClearLoopingSounds(qfalse);
	//CG_Printf("After ClearLoopSounds: %i -- %i\n", cgs.clientinfo[cg.clientNum].powerups, cgs.clientinfo[cg.clientNum].score);

	// clear all the render lists
	//CG_Printf("Before ClearScene: %i -- %i\n", cgs.clientinfo[cg.clientNum].powerups, cgs.clientinfo[cg.clientNum].score);
	trap_R_ClearScene();
	//CG_Printf("After ClearScene: %i -- %i\n", cgs.clientinfo[cg.clientNum].powerups, cgs.clientinfo[cg.clientNum].score);

	// set up cg.snap and possibly cg.nextSnap
	//CG_Printf("Before CG_ProcessSnapshot: %i -- %i\n", cgs.clientinfo[cg.clientNum].powerups, cgs.clientinfo[cg.clientNum].score);
	CG_ProcessSnapshots();
	//CG_Printf("After CG_ProcessSnapshot: %i -- %i\n", cgs.clientinfo[cg.clientNum].powerups, cgs.clientinfo[cg.clientNum].score);
	...
	// Can't change weapons without this.
	//CG_Printf("%i\n", cg.weaponSelect);
	...
	//CG_Printf("Begin CG_PredictPlayerState: %i -- %i\n", cgs.clientinfo[cg.clientNum].powerups, cgs.clientinfo[cg.clientNum].score);
	...
	//CG_Printf("End DrawActiveFrame: %i -- %i\n", cgs.clientinfo[cg.clientNum].powerups, cgs.clientinfo[cg.clientNum].score);
