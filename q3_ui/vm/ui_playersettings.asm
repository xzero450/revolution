...
byte 4 0
code
proc PlayerSettings_DrawName 108 24
...
line 110
;109:
;110:	UI_DrawProportionalString( basex, y, "Name", style, UI_ProportionalSizeScale( style ),  color );
ADDRLP4 20
INDIRI4
ARGI4
ADDRLP4 80
...
pop
line 150
;150:	UI_DrawProportionalString( 320, 440, name, UI_CENTER|UI_BIGFONT, 1.0, text_color_normal );
CNSTI4 320
ARGI4
CNSTI4 440
ARGI4
...
;151:}
LABELV $89
endproc PlayerSettings_DrawName 108 24
proc PlayerSettings_DrawHandicap 44 24
line 159
;152:
;153:
;154:/*
...
line 175
;174:
;175:	UI_DrawProportionalString( item->generic.x, item->generic.y, "Handicap", style, UI_ProportionalSizeScale( style ), color );
ADDRLP4 4
INDIRI4
ARGI4
ADDRLP4 24
...
pop
line 176
;176:	UI_DrawProportionalString( item->generic.x + 64, item->generic.y + PROP_HEIGHT, handicap_items[item->curvalue], style,UI_ProportionalSizeScale( style ), color );
ADDRLP4 4
INDIRI4
ARGI4
ADDRLP4 32
...
;177:}
LABELV $107
endproc PlayerSettings_DrawHandicap 44 24
...
line 201
;200:
;201:	UI_DrawProportionalString( item->generic.x, item->generic.y, "Effects", style, UI_ProportionalSizeScale( style ), color );
ADDRLP4 4
INDIRI4
ARGI4
ADDRLP4 24
