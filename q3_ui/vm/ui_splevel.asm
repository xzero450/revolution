...
proc UI_SPLevelMenu_ResetDraw 0 24
line 332
;325:
;326:
;327:/*
...
line 333
;333:	UI_DrawProportionalString( SCREEN_WIDTH/2, 356 + PROP_HEIGHT * 0, "WARNING: This resets all of the", UI_CENTER|UI_SMALLFONT, 0.75f, color_yellow );
CNSTI4 320
ARGI4
CNSTI4 356
ARGI4
...
pop
line 334
;334:	UI_DrawProportionalString( SCREEN_WIDTH/2, 356 + PROP_HEIGHT * 1, "single player game variables.", UI_CENTER|UI_SMALLFONT, 0.75f, color_yellow );
CNSTI4 320
ARGI4
CNSTI4 383
ARGI4
...
pop
line 335
;335:	UI_DrawProportionalString( SCREEN_WIDTH/2, 356 + PROP_HEIGHT * 2, "Do this only if you want to", UI_CENTER|UI_SMALLFONT, 0.75f, color_yellow );
CNSTI4 320
ARGI4
CNSTI4 410
ARGI4
...
pop
line 336
;336:	UI_DrawProportionalString( SCREEN_WIDTH/2, 356 + PROP_HEIGHT * 3, "start over from the beginning.", UI_CENTER|UI_SMALLFONT, 0.75f, color_yellow );
CNSTI4 320
ARGI4
CNSTI4 437
ARGI4
...
;337:}
LABELV $249
endproc UI_SPLevelMenu_ResetDraw 0 24
...
export UI_SPLevelMenu_CustomEvent
...
proc UI_SPLevelMenu_MenuDraw 1152 24
line 515
;506:
;507:
;508:/*
...
pop
line 534
;534:	UI_DrawProportionalString( 320, PLAYER_Y, string, UI_CENTER|UI_SMALLFONT, 0.75f, color_orange );
CNSTI4 320
ARGI4
CNSTI4 314
ARGI4
...
line 579
;578:
;579:	UI_DrawProportionalString( 18, 38, va( "Tier %i", selectedArenaSet + 1 ), UI_LEFT|UI_SMALLFONT, 0.75f, color_orange );
ADDRGP4 $333
ARGP4
ADDRGP4 selectedArenaSet
INDIRI4
...
LEI4 $343
line 588
;588:		UI_DrawProportionalString( 320, 216, "ACCESS DENIED", UI_CENTER|UI_BIGFONT, 1.0f, color_main );
CNSTI4 320
ARGI4
CNSTI4 216
ARGI4
...
pop
line 624
;624:	UI_DrawProportionalString( 320, y, string, UI_CENTER|UI_SMALLFONT, 0.75f, color_orange );
CNSTI4 320
ARGI4
ADDRLP4 8
INDIRI4
...
pop
line 639
;639:			UI_DrawProportionalString( x+22, y+18, "?", UI_BIGFONT, 1.0f, color_orange );
ADDRLP4 4
INDIRI4
CNSTI4 22
ADDI4
...
;643:}
LABELV $301
endproc UI_SPLevelMenu_MenuDraw 1152 24
...
ASGNP4
line 717
;717:	levelMenuInfo.item_banner.color					= color_main;
