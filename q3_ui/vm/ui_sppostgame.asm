...
;68:};
;69://Evo: I need to rework ui_medalSounds..
;70:char	*ui_medalSounds[] = {
;71:	"sound/feedback/accuracy.wav",
;72:	"sound/feedback/impressive_a.wav",
;73:	"sound/feedback/excellent_a.wav",
;74:	"sound/feedback/gauntlet.wav",
;75:	"sound/feedback/frags.wav",
;76:	"sound/feedback/perfect.wav"
;77:};
;78:
;79:/*
;80:=================
...
proc UI_SPPostgameMenu_DrawAwardsPresentation 40 24
line 219
;217:
;218:
...
ASGNF4
line 229
;229:	UI_DrawProportionalString( 320, 64, ui_medalNames[postgameMenuInfo.awardsEarned[awardNum]], UI_CENTER, 1.0f, color );
CNSTI4 320
ARGI4
CNSTI4 64
ARGI4
...
;237:}
LABELV $148
endproc UI_SPPostgameMenu_DrawAwardsPresentation 40 24
...
proc UI_SPPostgameMenu_MenuDraw 1060 24
line 276
;269:
;270:
;271:/*
...
LEI4 $179
line 291
;291:		UI_DrawProportionalString( 510, 480 - 64 - PROP_HEIGHT, postgameMenuInfo.placeNames[2], UI_CENTER, 1.0f, color_white );
CNSTI4 510
ARGI4
CNSTI4 389
ARGI4
...
LABELV $179
line 293
;293:	UI_DrawProportionalString( 130, 480 - 64 - PROP_HEIGHT, postgameMenuInfo.placeNames[1], UI_CENTER, 1.0f, color_white );
CNSTI4 130
ARGI4
CNSTI4 389
ARGI4
...
pop
line 294
;294:	UI_DrawProportionalString( 320, 480 - 64 - 2 * PROP_HEIGHT, postgameMenuInfo.placeNames[0], UI_CENTER, 1.0f, color_white );
CNSTI4 320
ARGI4
CNSTI4 362
ARGI4
...
;374:}
LABELV $174
endproc UI_SPPostgameMenu_MenuDraw 1060 24
