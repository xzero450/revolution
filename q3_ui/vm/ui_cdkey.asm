...
proc UI_CDKeyMenu_DrawKey 44 24
line 111
;103:}
;104:
;105:
...
NEI4 $108
line 153
;153:		UI_DrawProportionalString( 320, 376, "Please enter your CD Key", UI_CENTER, 0.75, color_yellow );
CNSTI4 320
ARGI4
CNSTI4 376
ARGI4
...
NEI4 $111
line 155
;155:		UI_DrawProportionalString( 320, 376, "The CD Key appears to be valid, thank you", UI_CENTER, 0.75, color_white );
CNSTI4 320
ARGI4
CNSTI4 376
ARGI4
...
LABELV $111
line 157
;157:		UI_DrawProportionalString( 320, 376, "The CD Key is not valid", UI_CENTER, 0.75, color_main );
CNSTI4 320
ARGI4
CNSTI4 376
ARGI4
...
;159:}
LABELV $98
endproc UI_CDKeyMenu_DrawKey 44 24
...
;162:/*
;163:===============
;164:UI_CDKeyMenu_Init
;165:===============
;166:*/
;167:static void UI_CDKeyMenu_Init( void ) {
line 168
;168:	trap_Cvar_Set( "ui_cdkeychecked", "1" );
ADDRGP4 $116
ARGP4
ADDRGP4 $117
ARGP4
...
line 170
;169:
;170:	UI_CDKeyMenu_Cache();
ADDRGP4 UI_CDKeyMenu_Cache
CALLV
pop
line 172
;171:
;172:	memset( &cdkeyMenuInfo, 0, sizeof(cdkeyMenuInfo) );
...
pop
line 173
;173:	cdkeyMenuInfo.menu.wrapAround = qtrue;
ADDRGP4 cdkeyMenuInfo+276
CNSTI4 1
ASGNI4
line 174
;174:	cdkeyMenuInfo.menu.fullscreen = qtrue;
ADDRGP4 cdkeyMenuInfo+280
CNSTI4 1
ASGNI4
line 176
;175:
;176:	cdkeyMenuInfo.banner.generic.type				= MTYPE_BTEXT;
ADDRGP4 cdkeyMenuInfo+288
CNSTI4 10
ASGNI4
line 177
;177:	cdkeyMenuInfo.banner.generic.x					= 320;
ADDRGP4 cdkeyMenuInfo+288+12
CNSTI4 320
ASGNI4
line 178
;178:	cdkeyMenuInfo.banner.generic.y					= 16;
ADDRGP4 cdkeyMenuInfo+288+16
CNSTI4 16
ASGNI4
line 179
;179:	cdkeyMenuInfo.banner.string						= "CD KEY";
ADDRGP4 cdkeyMenuInfo+288+60
ADDRGP4 $127
ASGNP4
line 180
;180:	cdkeyMenuInfo.banner.color						= color_white;
ADDRGP4 cdkeyMenuInfo+288+68
ADDRGP4 color_white
ASGNP4
line 181
;181:	cdkeyMenuInfo.banner.style						= UI_CENTER;
ADDRGP4 cdkeyMenuInfo+288+64
CNSTI4 1
ASGNI4
line 183
;182:
;183:	cdkeyMenuInfo.frame.generic.type				= MTYPE_BITMAP;
ADDRGP4 cdkeyMenuInfo+360
CNSTI4 6
ASGNI4
line 184
;184:	cdkeyMenuInfo.frame.generic.name				= ART_FRAME;
ADDRGP4 cdkeyMenuInfo+360+4
ADDRGP4 $135
ASGNP4
line 185
;185:	cdkeyMenuInfo.frame.generic.flags				= QMF_INACTIVE;
ADDRGP4 cdkeyMenuInfo+360+44
CNSTU4 16384
ASGNU4
line 186
;186:	cdkeyMenuInfo.frame.generic.x					= 142;
ADDRGP4 cdkeyMenuInfo+360+12
CNSTI4 142
ASGNI4
line 187
;187:	cdkeyMenuInfo.frame.generic.y					= 118;
ADDRGP4 cdkeyMenuInfo+360+16
CNSTI4 118
ASGNI4
line 188
;188:	cdkeyMenuInfo.frame.width  						= 359;
ADDRGP4 cdkeyMenuInfo+360+76
CNSTI4 359
ASGNI4
line 189
;189:	cdkeyMenuInfo.frame.height  					= 256;
ADDRGP4 cdkeyMenuInfo+360+80
CNSTI4 256
ASGNI4
line 191
;190:
;191:	cdkeyMenuInfo.cdkey.generic.type				= MTYPE_FIELD;
ADDRGP4 cdkeyMenuInfo+448
CNSTI4 4
ASGNI4
line 192
;192:	cdkeyMenuInfo.cdkey.generic.name				= "CD Key:";
ADDRGP4 cdkeyMenuInfo+448+4
ADDRGP4 $149
ASGNP4
line 193
;193:	cdkeyMenuInfo.cdkey.generic.flags				= QMF_LOWERCASE;
ADDRGP4 cdkeyMenuInfo+448+44
CNSTU4 262144
ASGNU4
line 194
;194:	cdkeyMenuInfo.cdkey.generic.x					= 320 - BIGCHAR_WIDTH * 2.5;
ADDRGP4 cdkeyMenuInfo+448+12
CNSTI4 280
ASGNI4
line 195
;195:	cdkeyMenuInfo.cdkey.generic.y					= 240 - BIGCHAR_HEIGHT / 2;
ADDRGP4 cdkeyMenuInfo+448+16
CNSTI4 232
ASGNI4
line 196
;196:	cdkeyMenuInfo.cdkey.field.widthInChars			= 16;
ADDRGP4 cdkeyMenuInfo+448+60+8
CNSTI4 16
ASGNI4
line 197
;197:	cdkeyMenuInfo.cdkey.field.maxchars				= 16;
ADDRGP4 cdkeyMenuInfo+448+60+268
CNSTI4 16
ASGNI4
line 198
;198:	cdkeyMenuInfo.cdkey.generic.ownerdraw			= UI_CDKeyMenu_DrawKey;
ADDRGP4 cdkeyMenuInfo+448+56
ADDRGP4 UI_CDKeyMenu_DrawKey
ASGNP4
line 200
;199:
;200:	cdkeyMenuInfo.accept.generic.type				= MTYPE_BITMAP;
ADDRGP4 cdkeyMenuInfo+780
CNSTI4 6
ASGNI4
line 201
;201:	cdkeyMenuInfo.accept.generic.name				= ART_ACCEPT0;
ADDRGP4 cdkeyMenuInfo+780+4
ADDRGP4 $167
ASGNP4
line 202
;202:	cdkeyMenuInfo.accept.generic.flags				= QMF_RIGHT_JUSTIFY|QMF_PULSEIFFOCUS;
ADDRGP4 cdkeyMenuInfo+780+44
CNSTU4 272
ASGNU4
line 203
;203:	cdkeyMenuInfo.accept.generic.id					= ID_ACCEPT;
ADDRGP4 cdkeyMenuInfo+780+8
CNSTI4 11
ASGNI4
line 204
;204:	cdkeyMenuInfo.accept.generic.callback			= UI_CDKeyMenu_Event;
ADDRGP4 cdkeyMenuInfo+780+48
ADDRGP4 UI_CDKeyMenu_Event
ASGNP4
line 205
;205:	cdkeyMenuInfo.accept.generic.x					= 640;
ADDRGP4 cdkeyMenuInfo+780+12
CNSTI4 640
ASGNI4
line 206
;206:	cdkeyMenuInfo.accept.generic.y					= 480-64;
ADDRGP4 cdkeyMenuInfo+780+16
CNSTI4 416
ASGNI4
line 207
;207:	cdkeyMenuInfo.accept.width						= 128;
ADDRGP4 cdkeyMenuInfo+780+76
CNSTI4 128
ASGNI4
line 208
;208:	cdkeyMenuInfo.accept.height						= 64;
ADDRGP4 cdkeyMenuInfo+780+80
CNSTI4 64
ASGNI4
line 209
;209:	cdkeyMenuInfo.accept.focuspic					= ART_ACCEPT1;
ADDRGP4 cdkeyMenuInfo+780+60
ADDRGP4 $184
ASGNP4
line 211
;210:
;211:	cdkeyMenuInfo.back.generic.type					= MTYPE_BITMAP;
ADDRGP4 cdkeyMenuInfo+868
CNSTI4 6
ASGNI4
line 212
;212:	cdkeyMenuInfo.back.generic.name					= ART_BACK0;
ADDRGP4 cdkeyMenuInfo+868+4
ADDRGP4 $188
ASGNP4
line 213
;213:	cdkeyMenuInfo.back.generic.flags				= QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS;
ADDRGP4 cdkeyMenuInfo+868+44
CNSTU4 260
ASGNU4
line 214
;214:	cdkeyMenuInfo.back.generic.id					= ID_BACK;
ADDRGP4 cdkeyMenuInfo+868+8
CNSTI4 12
ASGNI4
line 215
;215:	cdkeyMenuInfo.back.generic.callback				= UI_CDKeyMenu_Event;
ADDRGP4 cdkeyMenuInfo+868+48
ADDRGP4 UI_CDKeyMenu_Event
ASGNP4
line 216
;216:	cdkeyMenuInfo.back.generic.x					= 0;
ADDRGP4 cdkeyMenuInfo+868+12
CNSTI4 0
ASGNI4
line 217
;217:	cdkeyMenuInfo.back.generic.y					= 480-64;
ADDRGP4 cdkeyMenuInfo+868+16
CNSTI4 416
ASGNI4
line 218
;218:	cdkeyMenuInfo.back.width						= 128;
ADDRGP4 cdkeyMenuInfo+868+76
CNSTI4 128
ASGNI4
line 219
;219:	cdkeyMenuInfo.back.height						= 64;
ADDRGP4 cdkeyMenuInfo+868+80
CNSTI4 64
ASGNI4
line 220
;220:	cdkeyMenuInfo.back.focuspic						= ART_BACK1;
ADDRGP4 cdkeyMenuInfo+868+60
ADDRGP4 $205
ASGNP4
line 222
;221:
;222:	Menu_AddItem( &cdkeyMenuInfo.menu, &cdkeyMenuInfo.banner );
ADDRGP4 cdkeyMenuInfo
ARGP4
ADDRGP4 cdkeyMenuInfo+288
ARGP4
...
pop
line 223
;223:	Menu_AddItem( &cdkeyMenuInfo.menu, &cdkeyMenuInfo.frame );
ADDRGP4 cdkeyMenuInfo
ARGP4
ADDRGP4 cdkeyMenuInfo+360
ARGP4
...
pop
line 224
;224:	Menu_AddItem( &cdkeyMenuInfo.menu, &cdkeyMenuInfo.cdkey );
ADDRGP4 cdkeyMenuInfo
ARGP4
ADDRGP4 cdkeyMenuInfo+448
ARGP4
...
pop
line 225
;225:	Menu_AddItem( &cdkeyMenuInfo.menu, &cdkeyMenuInfo.accept );
ADDRGP4 cdkeyMenuInfo
ARGP4
ADDRGP4 cdkeyMenuInfo+780
ARGP4
...
EQI4 $210
line 227
;227:		Menu_AddItem( &cdkeyMenuInfo.menu, &cdkeyMenuInfo.back );
ADDRGP4 cdkeyMenuInfo
ARGP4
ADDRGP4 cdkeyMenuInfo+868
ARGP4
...
line 230
;229:
;230:	trap_GetCDKey( cdkeyMenuInfo.cdkey.field.buffer, cdkeyMenuInfo.cdkey.field.maxchars + 1 );
ADDRGP4 cdkeyMenuInfo+448+60+12
ARGP4
ADDRGP4 cdkeyMenuInfo+448+60+268
INDIRI4
...
pop
line 231
;231:	if( trap_VerifyCDKey( cdkeyMenuInfo.cdkey.field.buffer, NULL ) == qfalse ) {
ADDRGP4 cdkeyMenuInfo+448+60+12
ARGP4
CNSTP4 0
ARGP4
...
NEI4 $220
line 232
;232:		cdkeyMenuInfo.cdkey.field.buffer[0] = 0;
ADDRGP4 cdkeyMenuInfo+448+60+12
CNSTI1 0
ASGNI1
line 233
...
;237:/*
;238:=================
;239:UI_CDKeyMenu_Cache
;240:=================
;241:*/
;242:void UI_CDKeyMenu_Cache( void ) {
line 243
;243:	trap_R_RegisterShaderNoMip( ART_ACCEPT0 );
ADDRGP4 $167
ARGP4
...
pop
line 244
;244:	trap_R_RegisterShaderNoMip( ART_ACCEPT1 );
ADDRGP4 $184
ARGP4
ADDRGP4 trap_R_RegisterShaderNoMip
CALLI4
pop
line 245
;245:	trap_R_RegisterShaderNoMip( ART_BACK0 );
ADDRGP4 $188
ARGP4
ADDRGP4 trap_R_RegisterShaderNoMip
CALLI4
pop
line 246
;246:	trap_R_RegisterShaderNoMip( ART_BACK1 );
ADDRGP4 $205
ARGP4
ADDRGP4 trap_R_RegisterShaderNoMip
CALLI4
pop
line 247
;247:	trap_R_RegisterShaderNoMip( ART_FRAME );
ADDRGP4 $135
ARGP4
ADDRGP4 trap_R_RegisterShaderNoMip
CALLI4
...
;254:===============
;255:*/
;256:void UI_CDKeyMenu( void ) {
line 257
;257:	UI_CDKeyMenu_Init();
ADDRGP4 UI_CDKeyMenu_Init
CALLV
pop
line 258
;258:	UI_PushMenu( &cdkeyMenuInfo.menu );
ADDRGP4 cdkeyMenuInfo
ARGP4
ADDRGP4 UI_PushMenu
CALLV
