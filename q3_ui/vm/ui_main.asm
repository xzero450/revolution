...
;138:
;139:vmCvar_t	s_announcer;
;140:
;141:// bk001129 - made static to avoid aliasing.
;142:static cvarTable_t		cvarTable[] = {
;143:	{ &ui_ffa_fraglimit, "ui_ffa_fraglimit", "20", CVAR_ARCHIVE },
;144:	{ &ui_ffa_timelimit, "ui_ffa_timelimit", "0", CVAR_ARCHIVE },
;145:
;146:	{ &ui_tourney_fraglimit, "ui_tourney_fraglimit", "0", CVAR_ARCHIVE },
;147:	{ &ui_tourney_timelimit, "ui_tourney_timelimit", "15", CVAR_ARCHIVE },
;148:
;149:	{ &ui_team_fraglimit, "ui_team_fraglimit", "0", CVAR_ARCHIVE },
;150:	{ &ui_team_timelimit, "ui_team_timelimit", "20", CVAR_ARCHIVE },
;151:	{ &ui_team_friendly, "ui_team_friendly",  "1", CVAR_ARCHIVE },
;152:
;153:	{ &ui_ctf_capturelimit, "ui_ctf_capturelimit", "8", CVAR_ARCHIVE },
;154:	{ &ui_ctf_timelimit, "ui_ctf_timelimit", "30", CVAR_ARCHIVE },
;155:	{ &ui_ctf_friendly, "ui_ctf_friendly",  "0", CVAR_ARCHIVE },
;156:
;157:	{ &ui_arenasFile, "g_arenasFile", "", CVAR_INIT|CVAR_ROM },
;158:	{ &ui_botsFile, "g_botsFile", "", CVAR_INIT|CVAR_ROM },
;159:	{ &ui_spScores1, "g_spScores1", "", CVAR_ARCHIVE | CVAR_ROM },
;160:	{ &ui_spScores2, "g_spScores2", "", CVAR_ARCHIVE | CVAR_ROM },
;161:	{ &ui_spScores3, "g_spScores3", "", CVAR_ARCHIVE | CVAR_ROM },
;162:	{ &ui_spScores4, "g_spScores4", "", CVAR_ARCHIVE | CVAR_ROM },
;163:	{ &ui_spScores5, "g_spScores5", "", CVAR_ARCHIVE | CVAR_ROM },
;164:	{ &ui_spAwards, "g_spAwards", "", CVAR_ARCHIVE | CVAR_ROM },
;165:	{ &ui_spVideos, "g_spVideos", "", CVAR_ARCHIVE | CVAR_ROM },
;166:	{ &ui_spSkill, "g_spSkill", "2", CVAR_ARCHIVE | CVAR_LATCH },
;167:
;168:	{ &ui_spSelection, "ui_spSelection", "", CVAR_ROM },
;169:
;170:	{ &ui_browserMaster, "ui_browserMaster", "0", CVAR_ARCHIVE },
;171:	{ &ui_browserGameType, "ui_browserGameType", "0", CVAR_ARCHIVE },
;172:	{ &ui_browserSortKey, "ui_browserSortKey", "4", CVAR_ARCHIVE },
;173:	{ &ui_browserShowFull, "ui_browserShowFull", "1", CVAR_ARCHIVE },
;174:	{ &ui_browserShowEmpty, "ui_browserShowEmpty", "1", CVAR_ARCHIVE },
;175:
...
;199:
;200:	{ &s_announcer, "s_announcer", "feedback", CVAR_ARCHIVE }
;201:};
;202:
;203:// bk001129 - made static to avoid aliasing
;204:static int cvarTableSize = sizeof(cvarTable) / sizeof(cvarTable[0]);
;205:
;206:
;207:/*
;208:=================
;209:UI_RegisterCvars
;210:=================
;211:*/
;212:void UI_RegisterCvars( void ) {
line 216
;213:	int			i;
;214:	cvarTable_t	*cv;
;215:
;216:	for ( i = 0, cv = cvarTable ; i < cvarTableSize ; i++, cv++ ) {
ADDRLP4 4
CNSTI4 0
ASGNI4
ADDRLP4 0
...
LABELV $144
line 217
;217:		trap_Cvar_Register( cv->vmCvar, cv->cvarName, cv->defaultString, cv->cvarFlags );
ADDRLP4 0
INDIRP4
INDIRP4
ARGP4
