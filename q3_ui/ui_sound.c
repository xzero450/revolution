...
static void UI_SoundOptionsMenu_Init( void ) {
	...
	soundOptionsInfo.graphics.color				= color_main;
	...
	soundOptionsInfo.display.color				= color_main;
	...
	soundOptionsInfo.sound.color				= color_main;
	...
	soundOptionsInfo.network.color				= color_main;
