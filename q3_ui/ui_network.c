...
static void UI_NetworkOptionsMenu_Init( void ) {
	...
	networkOptionsInfo.graphics.color				= color_main;
	...
	networkOptionsInfo.display.color				= color_main;
	...
	networkOptionsInfo.sound.color					= color_main;
	...
	networkOptionsInfo.network.color				= color_main;
