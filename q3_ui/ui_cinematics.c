...
static void UI_CinematicsMenu_Init( void ) {
	...
	cinematicsMenuInfo.cin_idlogo.color				= color_main;
	...
	cinematicsMenuInfo.cin_intro.color				= color_main;
	...
	cinematicsMenuInfo.cin_tier1.color				= color_main;
	...
	cinematicsMenuInfo.cin_tier2.color				= color_main;
	...
	cinematicsMenuInfo.cin_tier3.color				= color_main;
	...
	cinematicsMenuInfo.cin_tier4.color				= color_main;
	...
	cinematicsMenuInfo.cin_tier5.color				= color_main;
	...
	cinematicsMenuInfo.cin_tier6.color				= color_main;
	...
	cinematicsMenuInfo.cin_tier7.color				= color_main;
	...
	cinematicsMenuInfo.cin_end.color				= color_main;
