...
static void UI_SPSkillMenu_SkillEvent( void *ptr, int notification ) {
	...
	SetSkillColor( (int)trap_Cvar_VariableValue( "g_spSkill" ), color_main );
...
static void UI_SPSkillMenu_Init( void ) {
	...
	skillMenuInfo.item_baby.color				= color_main;
	...
	skillMenuInfo.item_easy.color				= color_main;
	...
	skillMenuInfo.item_medium.color				= color_main;
	...
	skillMenuInfo.item_hard.color				= color_main;
	...
	skillMenuInfo.item_nightmare.color				= color_main;
