...
//Evo: I need to rework ui_medalSounds..
char	*ui_medalSounds[] = {
...
static void UI_SPPostgameMenu_DrawAwardsPresentation( int timer ) {
	...
	UI_DrawProportionalString( 320, 64, ui_medalNames[postgameMenuInfo.awardsEarned[awardNum]], UI_CENTER, 1.0f, color );
...
static void UI_SPPostgameMenu_MenuDraw( void ) {
	...
	if ( postgameMenuInfo.numClients > 2 ) {
		UI_DrawProportionalString( 510, 480 - 64 - PROP_HEIGHT, postgameMenuInfo.placeNames[2], UI_CENTER, 1.0f, color_white );
	}
	UI_DrawProportionalString( 130, 480 - 64 - PROP_HEIGHT, postgameMenuInfo.placeNames[1], UI_CENTER, 1.0f, color_white );
	UI_DrawProportionalString( 320, 480 - 64 - 2 * PROP_HEIGHT, postgameMenuInfo.placeNames[0], UI_CENTER, 1.0f, color_white );
