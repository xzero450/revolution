...
//
vec4_t color_main		= {0.00f, 0.75f, 1.00f, 1.00f};
...
static void PText_Draw( menutext_s *t )
{
	...
	UI_DrawProportionalString( x, y, t->string, style, UI_ProportionalSizeScale( style ), color );
}
...
void Menu_Cache( void )
{
	...
	//}
	uis.menuBackShader = trap_R_RegisterShaderNoMip( "menu/art/logo" );
	uis.connecting = trap_R_RegisterShaderNoMip( "menu/art/connecting" );
