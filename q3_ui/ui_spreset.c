...
static void Reset_MenuDraw( void ) {
	...
	UI_DrawProportionalString( 320, 194 + 10, "RESET GAME?", UI_CENTER|UI_INVERSE, 1.0f, color_main );
	UI_DrawProportionalString( s_reset.slashX, 265, "/", UI_LEFT|UI_INVERSE, 1.0f, color_main );
