...
static void MessageMenu_Draw( void ) {
	...
	{
		UI_DrawProportionalString( 320, y, s_confirm.lines[i], s_confirm.style, UI_ProportionalSizeScale( s_confirm.style ), color_main );
		y += 18;
	}
...
static void ConfirmMenu_Draw( void ) {
	UI_DrawNamedPic( 142, 118, 359, 256, ART_CONFIRM_FRAME );
	UI_DrawProportionalString( 320, 204, s_confirm.question, s_confirm.style, UI_ProportionalSizeScale( s_confirm.style ), color_main );
	UI_DrawProportionalString( s_confirm.slashX, 265, "/", UI_LEFT|UI_INVERSE, 1.0, color_main );
...
void UI_ConfirmMenu_Style( const char *question, int style, void (*draw)( void ), void (*action)( qboolean result ) ) {
	...
	s_confirm.yes.color				= color_main;
