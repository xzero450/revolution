...
static void UI_DisplayOptionsMenu_Init( void ) {
	...
	displayOptionsInfo.graphics.color				= color_main;
	...
	displayOptionsInfo.display.color				= color_main;
	...
	displayOptionsInfo.sound.color					= color_main;
	...
	displayOptionsInfo.network.color				= color_main;
