...
static void Setup_ResetDefaults_Draw( void ) {
	UI_DrawProportionalString( SCREEN_WIDTH/2, 356 + PROP_HEIGHT * 0, "WARNING: This will reset *ALL*", UI_CENTER|UI_SMALLFONT, 0.75f, color_yellow );
	UI_DrawProportionalString( SCREEN_WIDTH/2, 356 + PROP_HEIGHT * 1, "options to their default values.", UI_CENTER|UI_SMALLFONT, 0.75f, color_yellow );
}
...
static void UI_SetupMenu_Init( void ) {
	...
	setupMenuInfo.setupplayer.color					= color_main;
	...
	setupMenuInfo.setupcontrols.color				= color_main;
	...
	setupMenuInfo.setupsystem.color					= color_main;
	...
	setupMenuInfo.game.color						= color_main;
	...
	setupMenuInfo.cdkey.color						= color_main;
	...
	if( !trap_Cvar_VariableValue( "cl_paused" ) ) {
		...
		setupMenuInfo.defaults.color					= color_main;
