...
static void DriverInfo_MenuDraw( void )
{
	...
	UI_DrawString( 320, 80, "VENDOR", UI_CENTER|UI_SMALLFONT, color_main );
	UI_DrawString( 320, 152, "PIXELFORMAT", UI_CENTER|UI_SMALLFONT, color_main );
	UI_DrawString( 320, 192, "EXTENSIONS", UI_CENTER|UI_SMALLFONT, color_main );
...
void GraphicsOptions_MenuInit( void )
{
	...
	s_graphicsoptions.graphics.color			= color_main;
	...
	s_graphicsoptions.display.color				= color_main;
	...
	s_graphicsoptions.sound.color				= color_main;
	...
	s_graphicsoptions.network.color				= color_main;
	...
	s_graphicsoptions.driverinfo.color            = color_main;
	y += BIGCHAR_HEIGHT+2;
