...
static void Controls_ResetDefaults_Draw( void ) {
	UI_DrawProportionalString( SCREEN_WIDTH/2, 356 + PROP_HEIGHT * 0, "WARNING: This will reset all", UI_CENTER|UI_SMALLFONT, 0.75, color_yellow );
	UI_DrawProportionalString( SCREEN_WIDTH/2, 356 + PROP_HEIGHT * 1, "controls to their default values.", UI_CENTER|UI_SMALLFONT, 0.75, color_yellow );
}
...
static void Controls_MenuInit( void )
{
	...
	s_controls.looking.color			= color_main;
	...
	s_controls.movement.color			= color_main;
	...
	s_controls.weapons.color			= color_main;
	...
	s_controls.misc.color			= color_main;
