...
void InGame_MenuInit( void ) {
	...
	s_ingame.team.color					= color_main;
	...
	s_ingame.addbots.color				= color_main;
	...
	s_ingame.removebots.color				= color_main;
	...
	s_ingame.teamorders.color				= color_main;
	...
	s_ingame.setup.color				= color_main;
	...
	s_ingame.server.color				= color_main;
	...
	s_ingame.restart.color				= color_main;
	...
	s_ingame.resume.color					= color_main;
	...
	s_ingame.leave.color				= color_main;
	...
	s_ingame.quit.color					= color_main;
