...
line 163
;162:
;163:void trap_UnlinkEntity( gentity_t *ent ) {
line 165
;164:	//ent->relink = 0;
;165:	syscall( G_UNLINKENTITY, ent );
CNSTI4 31
ARGI4
ADDRFP4 0
INDIRP4
...
line 168
;167:
;168:int trap_EntitiesInBox( const vec3_t mins, const vec3_t maxs, int *list, int maxcount ) {
line 169
;169:	return syscall( G_ENTITIES_IN_BOX, mins, maxs, list, maxcount );
CNSTI4 32
ARGI4
ADDRFP4 0
INDIRP4
...
;170:}
;171:
;172:qboolean trap_EntityContact( const vec3_t mins, const vec3_t maxs, const gentity_t *ent ) {
line 173
;173:	return syscall( G_ENTITY_CONTACT, mins, maxs, ent );
CNSTI4 33
ARGI4
ADDRFP4 0
INDIRP4
...
;174:}
;175:
;176:qboolean trap_EntityContactCapsule( const vec3_t mins, const vec3_t maxs, const gentity_t *ent ) {
line 177
;177:	return syscall( G_ENTITY_CONTACTCAPSULE, mins, maxs, ent );
CNSTI4 44
ARGI4
ADDRFP4 0
INDIRP4
...
;178:}
;179:
;180:int trap_BotAllocateClient( void ) {
line 181
;181:	return syscall( G_BOT_ALLOCATE_CLIENT );
CNSTI4 34
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;182:}
;183:
;184:void trap_BotFreeClient( int clientNum ) {
line 185
;185:	syscall( G_BOT_FREE_CLIENT, clientNum );
CNSTI4 35
ARGI4
ADDRFP4 0
INDIRI4
...
line 188
;187:
;188:void trap_GetUsercmd( int clientNum, usercmd_t *cmd ) {
line 189
;189:	syscall( G_GET_USERCMD, clientNum, cmd );
CNSTI4 36
ARGI4
ADDRFP4 0
INDIRI4
...
line 192
;191:
;192:qboolean trap_GetEntityToken( char *buffer, int bufferSize ) {
line 193
;193:	return syscall( G_GET_ENTITY_TOKEN, buffer, bufferSize );
CNSTI4 37
ARGI4
ADDRFP4 0
INDIRP4
...
;194:}
;195:
;196:int trap_DebugPolygonCreate(int color, int numPoints, vec3_t *points) {
line 197
;197:	return syscall( G_DEBUG_POLYGON_CREATE, color, numPoints, points );
CNSTI4 39
ARGI4
ADDRFP4 0
INDIRI4
...
;198:}
;199:
;200:void trap_DebugPolygonDelete(int id) {
line 201
;201:	syscall( G_DEBUG_POLYGON_DELETE, id );
CNSTI4 40
ARGI4
ADDRFP4 0
INDIRI4
...
line 204
;203:
;204:int trap_RealTime( qtime_t *qtime ) {
line 205
;205:	return syscall( G_REAL_TIME, qtime );
CNSTI4 41
ARGI4
ADDRFP4 0
INDIRP4
...
;206:}
;207:
;208:void trap_SnapVector( float *v ) {
line 209
;209:	syscall( G_SNAPVECTOR, v );
CNSTI4 42
ARGI4
ADDRFP4 0
INDIRP4
...
;211:}
;212:
;213:// BotLib traps start here
;214:int trap_BotLibSetup( void ) {
line 215
;215:	return syscall( BOTLIB_SETUP );
CNSTI4 200
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;216:}
;217:
;218:int trap_BotLibShutdown( void ) {
line 219
;219:	return syscall( BOTLIB_SHUTDOWN );
CNSTI4 201
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;220:}
;221:
;222:int trap_BotLibVarSet(char *var_name, char *value) {
line 223
;223:	return syscall( BOTLIB_LIBVAR_SET, var_name, value );
CNSTI4 202
ARGI4
ADDRFP4 0
INDIRP4
...
;224:}
;225:
;226:int trap_BotLibVarGet(char *var_name, char *value, int size) {
line 227
;227:	return syscall( BOTLIB_LIBVAR_GET, var_name, value, size );
CNSTI4 203
ARGI4
ADDRFP4 0
INDIRP4
...
;228:}
;229:
;230:int trap_BotLibDefine(char *string) {
line 231
;231:	return syscall( BOTLIB_PC_ADD_GLOBAL_DEFINE, string );
CNSTI4 204
ARGI4
ADDRFP4 0
INDIRP4
...
;232:}
;233:
;234:int trap_BotLibStartFrame(float time) {
line 235
;235:	return syscall( BOTLIB_START_FRAME, PASSFLOAT( time ) );
ADDRFP4 0
INDIRF4
ARGF4
ADDRLP4 0
...
;236:}
;237:
;238:int trap_BotLibLoadMap(const char *mapname) {
line 239
;239:	return syscall( BOTLIB_LOAD_MAP, mapname );
CNSTI4 206
ARGI4
ADDRFP4 0
INDIRP4
...
;240:}
;241:
;242:int trap_BotLibUpdateEntity(int ent, void /* struct bot_updateentity_s */ *bue) {
line 243
;243:	return syscall( BOTLIB_UPDATENTITY, ent, bue );
CNSTI4 207
ARGI4
ADDRFP4 0
INDIRI4
...
;244:}
;245:
;246:int trap_BotLibTest(int parm0, char *parm1, vec3_t parm2, vec3_t parm3) {
line 247
;247:	return syscall( BOTLIB_TEST, parm0, parm1, parm2, parm3 );
CNSTI4 208
ARGI4
ADDRFP4 0
INDIRI4
...
;248:}
;249:
;250:int trap_BotGetSnapshotEntity( int clientNum, int sequence ) {
line 251
;251:	return syscall( BOTLIB_GET_SNAPSHOT_ENTITY, clientNum, sequence );
CNSTI4 209
ARGI4
ADDRFP4 0
INDIRI4
...
;252:}
;253:
;254:int trap_BotGetServerCommand(int clientNum, char *message, int size) {
line 255
;255:	return syscall( BOTLIB_GET_CONSOLE_MESSAGE, clientNum, message, size );
CNSTI4 210
ARGI4
ADDRFP4 0
INDIRI4
...
;256:}
;257:
;258:void trap_BotUserCommand(int clientNum, usercmd_t *ucmd) {
line 259
;259:	syscall( BOTLIB_USER_COMMAND, clientNum, ucmd );
CNSTI4 211
ARGI4
ADDRFP4 0
INDIRI4
...
line 262
;261:
;262:void trap_AAS_EntityInfo(int entnum, void /* struct aas_entityinfo_s */ *info) {
line 263
;263:	syscall( BOTLIB_AAS_ENTITY_INFO, entnum, info );
CNSTI4 303
ARGI4
ADDRFP4 0
INDIRI4
...
line 266
;265:
;266:int trap_AAS_Initialized(void) {
line 267
;267:	return syscall( BOTLIB_AAS_INITIALIZED );
CNSTI4 304
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;268:}
;269:
;270:void trap_AAS_PresenceTypeBoundingBox(int presencetype, vec3_t mins, vec3_t maxs) {
line 271
;271:	syscall( BOTLIB_AAS_PRESENCE_TYPE_BOUNDING_BOX, presencetype, mins, maxs );
CNSTI4 305
ARGI4
ADDRFP4 0
INDIRI4
...
line 274
;273:
;274:float trap_AAS_Time(void) {
line 276
;275:	int temp;
;276:	temp = syscall( BOTLIB_AAS_TIME );
CNSTI4 306
ARGI4
ADDRLP4 4
ADDRGP4 syscall
...
;278:}
;279:
;280:int trap_AAS_PointAreaNum(vec3_t point) {
line 281
;281:	return syscall( BOTLIB_AAS_POINT_AREA_NUM, point );
CNSTI4 307
ARGI4
ADDRFP4 0
INDIRP4
...
;282:}
;283:
;284:int trap_AAS_PointReachabilityAreaIndex(vec3_t point) {
line 285
;285:	return syscall( BOTLIB_AAS_POINT_REACHABILITY_AREA_INDEX, point );
CNSTI4 577
ARGI4
ADDRFP4 0
INDIRP4
...
;286:}
;287:
;288:int trap_AAS_TraceAreas(vec3_t start, vec3_t end, int *areas, vec3_t *points, int maxareas) {
line 289
;289:	return syscall( BOTLIB_AAS_TRACE_AREAS, start, end, areas, points, maxareas );
CNSTI4 308
ARGI4
ADDRFP4 0
INDIRP4
...
;290:}
;291:
;292:int trap_AAS_BBoxAreas(vec3_t absmins, vec3_t absmaxs, int *areas, int maxareas) {
line 293
;293:	return syscall( BOTLIB_AAS_BBOX_AREAS, absmins, absmaxs, areas, maxareas );
CNSTI4 301
ARGI4
ADDRFP4 0
INDIRP4
...
;294:}
;295:
;296:int trap_AAS_AreaInfo( int areanum, void /* struct aas_areainfo_s */ *info ) {
line 297
;297:	return syscall( BOTLIB_AAS_AREA_INFO, areanum, info );
CNSTI4 302
ARGI4
ADDRFP4 0
INDIRI4
...
;298:}
;299:
;300:int trap_AAS_PointContents(vec3_t point) {
line 301
;301:	return syscall( BOTLIB_AAS_POINT_CONTENTS, point );
CNSTI4 309
ARGI4
ADDRFP4 0
INDIRP4
...
;302:}
;303:
;304:int trap_AAS_NextBSPEntity(int ent) {
line 305
;305:	return syscall( BOTLIB_AAS_NEXT_BSP_ENTITY, ent );
CNSTI4 310
ARGI4
ADDRFP4 0
INDIRI4
...
;306:}
;307:
;308:int trap_AAS_ValueForBSPEpairKey(int ent, char *key, char *value, int size) {
line 309
;309:	return syscall( BOTLIB_AAS_VALUE_FOR_BSP_EPAIR_KEY, ent, key, value, size );
CNSTI4 311
ARGI4
ADDRFP4 0
INDIRI4
...
;310:}
;311:
;312:int trap_AAS_VectorForBSPEpairKey(int ent, char *key, vec3_t v) {
line 313
;313:	return syscall( BOTLIB_AAS_VECTOR_FOR_BSP_EPAIR_KEY, ent, key, v );
CNSTI4 312
ARGI4
ADDRFP4 0
INDIRI4
...
;314:}
;315:
;316:int trap_AAS_FloatForBSPEpairKey(int ent, char *key, float *value) {
line 317
;317:	return syscall( BOTLIB_AAS_FLOAT_FOR_BSP_EPAIR_KEY, ent, key, value );
CNSTI4 313
ARGI4
ADDRFP4 0
INDIRI4
...
;318:}
;319:
;320:int trap_AAS_IntForBSPEpairKey(int ent, char *key, int *value) {
line 321
;321:	return syscall( BOTLIB_AAS_INT_FOR_BSP_EPAIR_KEY, ent, key, value );
CNSTI4 314
ARGI4
ADDRFP4 0
INDIRI4
...
;322:}
;323:
;324:int trap_AAS_AreaReachability(int areanum) {
line 325
;325:	return syscall( BOTLIB_AAS_AREA_REACHABILITY, areanum );
CNSTI4 315
ARGI4
ADDRFP4 0
INDIRI4
...
;326:}
;327:
;328:int trap_AAS_AreaTravelTimeToGoalArea(int areanum, vec3_t origin, int goalareanum, int travelflags) {
line 329
;329:	return syscall( BOTLIB_AAS_AREA_TRAVEL_TIME_TO_GOAL_AREA, areanum, origin, goalareanum, travelflags );
CNSTI4 316
ARGI4
ADDRFP4 0
INDIRI4
...
;330:}
;331:
;332:int trap_AAS_EnableRoutingArea( int areanum, int enable ) {
line 333
;333:	return syscall( BOTLIB_AAS_ENABLE_ROUTING_AREA, areanum, enable );
CNSTI4 300
ARGI4
ADDRFP4 0
INDIRI4
...
;334:}
;335:
;336:int trap_AAS_PredictRoute(void /*struct aas_predictroute_s*/ *route, int areanum, vec3_t origin,
;337:							int goalareanum, int travelflags, int maxareas, int maxtime,
;338:							int stopevent, int stopcontents, int stoptfl, int stopareanum) {
line 339
;339:	return syscall( BOTLIB_AAS_PREDICT_ROUTE, route, areanum, origin, goalareanum, travelflags, maxareas, maxtime, stopevent, stopcontents, stoptfl, stopareanum );
CNSTI4 576
ARGI4
ADDRFP4 0
INDIRP4
...
;340:}
;341:
;342:int trap_AAS_AlternativeRouteGoals(vec3_t start, int startareanum, vec3_t goal, int goalareanum, int travelflags,
;343:										void /*struct aas_altroutegoal_s*/ *altroutegoals, int maxaltroutegoals,
;344:										int type) {
line 345
;345:	return syscall( BOTLIB_AAS_ALTERNATIVE_ROUTE_GOAL, start, startareanum, goal, goalareanum, travelflags, altroutegoals, maxaltroutegoals, type );
CNSTI4 575
ARGI4
ADDRFP4 0
INDIRP4
...
;346:}
;347:
;348:int trap_AAS_Swimming(vec3_t origin) {
line 349
;349:	return syscall( BOTLIB_AAS_SWIMMING, origin );
CNSTI4 317
ARGI4
ADDRFP4 0
INDIRP4
...
;350:}
;351:
;352:int trap_AAS_PredictClientMovement(void /* struct aas_clientmove_s */ *move, int entnum, vec3_t origin, int presencetype, int onground, vec3_t velocity, vec3_t cmdmove, int cmdframes, int maxframes, float frametime, int stopevent, int stopareanum, int visualize) {
line 353
;353:	return syscall( BOTLIB_AAS_PREDICT_CLIENT_MOVEMENT, move, entnum, origin, presencetype, onground, velocity, cmdmove, cmdframes, maxframes, PASSFLOAT(frametime), stopevent, stopareanum, visualize );
ADDRFP4 36
INDIRF4
ARGF4
ADDRLP4 0
...
;354:}
;355:
;356:void trap_EA_Say(int client, char *str) {
line 357
;357:	syscall( BOTLIB_EA_SAY, client, str );
CNSTI4 400
ARGI4
ADDRFP4 0
INDIRI4
...
line 360
;359:
;360:void trap_EA_SayTeam(int client, char *str) {
line 361
;361:	syscall( BOTLIB_EA_SAY_TEAM, client, str );
CNSTI4 401
ARGI4
ADDRFP4 0
INDIRI4
...
line 364
;363:
;364:void trap_EA_Command(int client, char *command) {
line 365
;365:	syscall( BOTLIB_EA_COMMAND, client, command );
CNSTI4 402
ARGI4
ADDRFP4 0
INDIRI4
...
line 368
;367:
;368:void trap_EA_Action(int client, int action) {
line 369
;369:	syscall( BOTLIB_EA_ACTION, client, action );
CNSTI4 403
ARGI4
ADDRFP4 0
INDIRI4
...
line 372
;371:
;372:void trap_EA_Gesture(int client) {
line 373
;373:	syscall( BOTLIB_EA_GESTURE, client );
CNSTI4 404
ARGI4
ADDRFP4 0
INDIRI4
...
line 376
;375:
;376:void trap_EA_Talk(int client) {
line 377
;377:	syscall( BOTLIB_EA_TALK, client );
CNSTI4 405
ARGI4
ADDRFP4 0
INDIRI4
...
line 380
;379:
;380:void trap_EA_Attack(int client) {
line 381
;381:	syscall( BOTLIB_EA_ATTACK, client );
CNSTI4 406
ARGI4
ADDRFP4 0
INDIRI4
...
line 384
;383:
;384:void trap_EA_Use(int client) {
line 385
;385:	syscall( BOTLIB_EA_USE, client );
CNSTI4 407
ARGI4
ADDRFP4 0
INDIRI4
...
line 388
;387:
;388:void trap_EA_Respawn(int client) {
line 389
;389:	syscall( BOTLIB_EA_RESPAWN, client );
CNSTI4 408
ARGI4
ADDRFP4 0
INDIRI4
...
line 392
;391:
;392:void trap_EA_Crouch(int client) {
line 393
;393:	syscall( BOTLIB_EA_CROUCH, client );
CNSTI4 409
ARGI4
ADDRFP4 0
INDIRI4
...
line 396
;395:
;396:void trap_EA_MoveUp(int client) {
line 397
;397:	syscall( BOTLIB_EA_MOVE_UP, client );
CNSTI4 410
ARGI4
ADDRFP4 0
INDIRI4
...
line 400
;399:
;400:void trap_EA_MoveDown(int client) {
line 401
;401:	syscall( BOTLIB_EA_MOVE_DOWN, client );
CNSTI4 411
ARGI4
ADDRFP4 0
INDIRI4
...
line 404
;403:
;404:void trap_EA_MoveForward(int client) {
line 405
;405:	syscall( BOTLIB_EA_MOVE_FORWARD, client );
CNSTI4 412
ARGI4
ADDRFP4 0
INDIRI4
...
line 408
;407:
;408:void trap_EA_MoveBack(int client) {
line 409
;409:	syscall( BOTLIB_EA_MOVE_BACK, client );
CNSTI4 413
ARGI4
ADDRFP4 0
INDIRI4
...
line 412
;411:
;412:void trap_EA_MoveLeft(int client) {
line 413
;413:	syscall( BOTLIB_EA_MOVE_LEFT, client );
CNSTI4 414
ARGI4
ADDRFP4 0
INDIRI4
...
line 416
;415:
;416:void trap_EA_MoveRight(int client) {
line 417
;417:	syscall( BOTLIB_EA_MOVE_RIGHT, client );
CNSTI4 415
ARGI4
ADDRFP4 0
INDIRI4
...
line 420
;419:
;420:void trap_EA_SelectWeapon(int client, int weapon) {
line 421
;421:	syscall( BOTLIB_EA_SELECT_WEAPON, client, weapon );
CNSTI4 416
ARGI4
ADDRFP4 0
INDIRI4
